...
import (
	"github.com/open-telemetry/opentelemetry-collector-contrib/processor/hypermonitorrelationmetricprocessor"
...
func Components() (component.Factories, error) {
	...
	processors := []component.ProcessorFactory{
		...
		hypermonitorrelationmetricprocessor.NewFactory(), // 2022.05.17添加
